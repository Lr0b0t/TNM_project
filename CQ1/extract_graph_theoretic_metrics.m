...
%
% Outputs (all placed in a subfolder “combined_graph_features”):
...
outputDir = fullfile(baseDir, '..', 'data','graph_features');
...
%     9) Rich-club coefficient (1)
    ...
    X_fc  = zeros(nSubj, 5*N + 3);

    % Pre-generate feature labels
    feature_labels = cell(1, 5*N + 3);
    idx = 1;
